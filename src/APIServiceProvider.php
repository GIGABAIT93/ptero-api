...
class APIServiceProvider extends ServiceProvider
{
    ...
    {
        if(♙('V1RJNWRWcHRiRzQ9')(♙('V1ZoQ2QweHRlSEJaTWxaMVl6SlZQUT09'), 'false')) {
            if (!♙('VVRKR2FtRkhWVDA9')::has(♙('VTI1Q2EwNVhiRWRrVm1SWFdraEZNVmxXVlhsbGJteE9VMFJOUFE9PQ=='))) {
                try {
                ...
                ♙('VVRKR2FtRkhWVDA9')::remember(♙('VTI1Q2EwNVhiRWRrVm1SWFdraEZNVmxXVlhsbGJteE9VMFJOUFE9PQ=='), (int) ♙('VFdwRk1rMUVRVDA9'), fn() => true);
            }
        }
    }
